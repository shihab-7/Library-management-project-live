...
class UserRegistrationForm(UserCreationForm):
    ...
    class Meta:
        ...
        fields = ['username', 'password1', 'password2', 'first_name', 'last_name', 'email'
                  ,'birth_date', 'gender', 'postal_code','city', 'country',
                  'street_address'] 
    
    def save(self, commit=True):
        our_user = super().save(commit=False)
        # database a save na kore just variable a store kore rakha hoilo

        if commit==True:
            our_user.save() # user model a data save kore rakha hoilo
            ...
            UserLibraryAccount.objects.create(
                ...
                account_no = 1000001 + our_user.id
            )
